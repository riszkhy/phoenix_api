defmodule PhoenixApi.UsersTest do
  ...
  describe "users" do
    ...
    @invalid_attrs %{biography: nil, fullname: nil, gender: nil}
    ...
    test "create_user/1 with valid data creates a user" do
      valid_attrs = %{biography: "some biography", fullname: "some fullname", gender: "some gender"}
    ...
    test "update_user/2 with valid data updates the user" do
      user = user_fixture()
      update_attrs = %{biography: "some updated biography", fullname: "some updated fullname", gender: "some updated gender"}
